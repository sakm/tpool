...
<nav class="navbar navbar-default sidebar" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="Unallocation.jsp">Unallocate Trainer<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
...
<div class="search">
<input type="search" name="CId" value="Course Id"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="search" name="FilterFromDate" value="01/30/2000"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="search" name="FilterToDate" value="01/30/2000"  >&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>	
		...
		HashMap pm=(HashMap)hsn.getAttribute("ProgramMap");
		 ArrayList<Trainer> alt= (ArrayList)hsn.getAttribute("trainerListBySkill");
		 for(Trainer t: alt )
		  {
		    out.println(t.gettAge());
		    break;
		  }
		 ...
		 %>
		  <% out.println("t.getTrainerId()");
			if(pm.size()!=0)
			{
				out.println("hm"+pm.size());
			}
			
			if(al.size()!=0)
			{
				out.println("al"+al.size());
			}
		 ...
		 <%
			for(Trainer t:al){
				...
				<% 
				out.println("t.getTrainerId()"+t.gettAge());
		...
		<td><input type="checkbox" name="UpdateAllocation" value="AllocateTrainers" style="display: flex" >
	...
	<td><input type="submit" name="AdminAction" value="Allocate" style="display: flex" >
