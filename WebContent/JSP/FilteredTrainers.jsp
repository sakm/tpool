...
<input type="date" name="FilterFromDate" placeholder="FilterFromDate" required="required">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="date" name="FilterToDate" placeholder="FilterToDate" required="required">&nbsp;&nbsp;&nbsp;&nbsp;
